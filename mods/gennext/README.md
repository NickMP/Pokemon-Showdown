...
- Trick Room lasts 8 turns if user is holding a Lustrous Orb.
...
- Rapid Spin now has 30 base power and removes hazards before faiting
...
- unbanned: Gengarite, Kangaskhanite, Lucarionite, Mawilite, Blaziken, Genesect, Aegislash
